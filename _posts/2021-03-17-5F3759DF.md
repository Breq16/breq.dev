...
Now, what happens if we take the logarithm? Let's take the log base 2, since we're working with binary.
...
<iframe src="https://www.desmos.com/calculator/yvwmijecdr?embed" width="500px" height="500px" style="border: 1px solid #ccc" frameborder=0></iframe>
...
And there it is: we have our fast logarithm.
...
<iframe src="https://www.desmos.com/calculator/ibkfxugxss?embed" width="500px" height="500px" style="border: 1px solid #ccc" frameborder=0></iframe>
...
$$ f'(t) = \frac{d}{dt} [\frac{1}{t^2} - x] = \frac{d}{dt} t^{-2} = -2t^{-3} $$
...
$$ t = t_0 ( \frac{3}{2} - \frac{x}{2} \cdot t_0^2 ) $$
